...
class TomorrowScheduleNotificationSchedulerTest {
    @Mock
    ...
    @InjectMocks
    TomorrowScheduleNotificationScheduler scheduleDifferenceNotificationScheduler;
    ...
    void sendScheduleNotificationsToUsers() {
        ...
        when(notificationService.createTomorrowScheduleNotificationsMessages()).thenReturn(messages);
        ...
        //Assert
        verify(notificationService).createTomorrowScheduleNotificationsMessages();
